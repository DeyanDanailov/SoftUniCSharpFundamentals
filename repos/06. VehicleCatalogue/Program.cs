    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (command != "End")
            {
                ...
                Vehicle vehicle = new Vehicle(commandElements[0], commandElements[1],
                    commandElements[2], double.Parse(commandElements[3]));
            ...
            var truckAveragePower = trucksHorsePower / trucks.Count();
            if (cars.Count == 0)
            {
                carAveragePower = 0;
            }
